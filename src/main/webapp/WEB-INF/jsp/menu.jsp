        ...
        <div class="menu-gallery">
          <div class="menu-category featured">
            <div class="image-placeholder">
              <img
                src="<c:url value='/images/menu-images/menu-principal.jpg'/>"
                alt="Especialidades"
          ...
          <div class="category-pair">
            <div class="menu-category">
              <div class="image-placeholder">
                <img
                  src="<c:url value='/images/menu-images/menu-picar.jpg'/>"
                  alt="Para picar"
                  onclick="openZoom(this)" />
              </div>
              <h3>Para picar</h3>
            ...
            <div class="menu-category">
              <div class="image-placeholder">
                <img
                  src="<c:url value='/images/menu-images/menu-clasicos.jpg'/>"
                  alt="Los clásicos"
                  onclick="openZoom(this)" />
              </div>
              <h3>Los clásicos</h3>
          ...
          <div class="category-pair">
            <div class="menu-category">
              <div class="image-placeholder">
                <img
                  src="<c:url value='/images/menu-images/menu-criollos.jpg'/>"
            ...
            <div class="menu-category">
              <div class="image-placeholder">
                <img
                  src="<c:url value='/images/menu-images/menu-parrilla.jpg'/>"
                  alt="De la parrilla"
                  onclick="openZoom(this)" />
              </div>
          ...
          <div class="category-pair">
            <div class="menu-category">
              <div class="image-placeholder">
                <img
                  src="<c:url value='/images/menu-images/menu-kids-postres.jpg'/>"
            ...
            <div class="menu-category">
              <div class="image-placeholder">
                <img
                  src="<c:url value='/images/menu-images/menu-bebidas-refrescos.jpg'/>"
