          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto ms-4">
              ...
              <c:if test="${sessionScope.usuario.rol == 'ADMIN'}">
                <li class="nav-item">
                  <a class="nav-link active" href="<c:url value='/admin'/>">PANEL ADMIN</a>
                </li>
              </c:if>
            </ul>
            <c:if test="${not empty sessionScope.usuario}">
    ...
    <div class="container mt-5">
      ...
      <div class="row mb-3">
        <div class="col-md-4 offset-md-4">
          <label for="filtroFecha" class="form-label fw-bold">Filtrar por Fecha:</label>
          <input
            type="date"
            class="form-control"
            id="filtroFecha"
        ...
        <div class="col-md-2">
          ...
          <select class="form-select" id="filtroHora">
            ...
            <c:forEach var="franja" items="${franjasHorarias}">
              <option value="${franja.idFranja}">${franja.franjaHoraria}</option>
            </c:forEach>
          </select>
        </div>
        <div class="col-md-2">
          ...
          <tbody id="tablaReservas">
            <c:forEach var="reserva" items="${reservas}">
              <tr id="reserva-${reserva.idReserva}">
                ...
                <td class="fw-bold text-capitalize">${reserva.estado}</td>                <td>
                  <button
