...
<form:form
  ...
  <div class="row">
    ...
    <div class="col-md-6 mb-4">
      ...
      <!-- CAMPO FECHA MOVIDO AQUÍ -->
      <div class="mb-3">
        <label for="fecha" class="form-label">Fecha</label>
        <form:input type="date" class="form-control" id="fecha" path="fecha" value="${fechaSeleccionada}" min="${fechaMin}" max="${fechaMax}" required="true" />
      </div>
      <div class="mb-3">
        <button type="submit"
                formaction="${pageContext.request.contextPath}/reservaciones"
                formmethod="get"
      ...
      <div class="mb-3">
        ...
        <form:select class="form-select" id="idFranja" path="idFranja" required="true">
          <form:option value="">Selecciona una franja</form:option>
          <c:forEach var="franja" items="${franjasHorarias}">
            <form:option value="${franja.idFranja}">
              ${franja.franjaHoraria}
              <c:if test="${franja.estaCasiLleno}"> (Ocupado +70%)</c:if>
            </form:option>
          </c:forEach>
        </form:select>
      </div>
